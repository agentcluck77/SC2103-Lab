...
HD_PWD='C:/SC2103-Lab-main/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AM_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AM_top.tcl
