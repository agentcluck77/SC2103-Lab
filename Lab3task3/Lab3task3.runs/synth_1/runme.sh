...
HD_PWD='C:/SC2103-Lab-main/Lab3task3/Lab3task3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AMP_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AMP_top.tcl
