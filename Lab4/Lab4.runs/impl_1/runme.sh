...
HD_PWD='C:/SC2103-Lab-main/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uP16_BASYS3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uP16_BASYS3_top.tcl -notrace
