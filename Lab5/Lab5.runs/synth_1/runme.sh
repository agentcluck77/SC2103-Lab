...
HD_PWD='D:/SC2103-Lab-main/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uP16_BASYS3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uP16_BASYS3_top.tcl
