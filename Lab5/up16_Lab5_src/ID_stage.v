...
module DF_control (
	...
	assign Data1_muxCont = (EX_RFwriteEnab && (RR1_rd == EX_RFdest_rd)) ? 2'b01 :
								  (Mem_RFwriteEnab && (RR1_rd == Mem_RFdest_rd)) ? 2'b10 :
								  2'b00;
	assign Data2_muxCont = (EX_RFwriteEnab && (RR2_rs == EX_RFdest_rd)) ? 2'b01 :
								  (Mem_RFwriteEnab && (RR2_rs == Mem_RFdest_rd)) ? 2'b10 :
								  2'b00;
